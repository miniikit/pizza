                        ...
                        <tr>
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <td class="form-inline">
                                    ...
                                    <span class="example">例)情報太郎</span> @if ($errors->has('name'))
                            ...
                            <div class="form-group{{ $errors->has('kana') ? ' has-error' : '' }}">
                                ...
                                <td class="form-inline">
                                    <input id="kana" type="text" class="form-control" name="kana"
                                           value="{{ old('name') }}" required autofocus>
                                    <span class="example">例)ジョウホウタロウ</span> @if ($errors->has('kana'))
                                        <span class="help-block">
                        ...
                        <tr>
                            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                ...
                                <td class="form-inline">
                                    ...
                                    <span class="example">例)oic@example.com</span> @if ($errors->has('email'))
                                        <span class="help-block">
                        ...
                        <tr>
                            <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                ...
                                <td class="form-inline">
                                    ...
                                    <span class="example">数字とアルファベット大文字を一文字ずつ、6文字以上入力してください。</span> @if ($errors->has('password'))
                                        <span class="help-block">
                            ...
                            <div class="form-group">
                                ...
                                <td class="form-inline">
                                    <input type="text" class="form-control" name="postal"
                                           onKeyup="this.value=this.value.replace(/[^0-9]+/i,'')" size="5" maxlength="7"
                                           onKeyup="AjaxZip3.zip2addr('postal','','pref','address1');">
                                    <input type="button" class="form-btn" name="postal"
                                           onClick="AjaxZip3.zip2addr('postal','','pref','address1');" value="〒→変換"
                                           onKeyup="AjaxZip3.zip2addr('postal','','pref','address1');">
                                    <span class="example">例)0000000</span>
                                </td>
                        </tr>
                            ...
                            <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                ...
                                <td class="form-inline">
                                    <input id="phone" type="text" class="form-control" name="phone"
                                           onKeyup="this.value=this.value.replace(/[^0-9]+/i,'')" maxlength="11"
