            ...
            <table class="table">
              <tbody>
                ...
                <tr>
                  ...
                  <td><input class="form-control" style="width:30%;" type="text" name="name" value=""></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td><input class="form-control" type="text" name="name" placeholder="回" value="" style="width:10%"></td>
                </tr>
                <tr>
                  <th class="text-center" style="padding-top:12px;"><label for="">上限回数</label></th>
                  <td><input type="radio" name="name" value="">指定しない</td>
                ...
                <tr>
                  ...
                  <input type="radio" name="name" value="">新規のみ</td>
                </tr>
              </tbody>
            </table>
