    ...
    <form action="/pizzzzza/coupon/add/gift/do" method="post">
        <table class="table table-bordered ">
            ...
            <tr>
                ...
                <td><input class="form-control" type="text" name="coupon_name" value="{{ old('coupon_name') }}" placeholder="冬限定５００円OFFクーポン">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input class="form-control" type="number" name="coupon_max" value="{{ old('coupon_max') }}"
