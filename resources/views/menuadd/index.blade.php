...
<!--  <thead>
  ...
  <tbody>
    <tr>
      <th><label for="">価格</label></th>
      <td><input class="form-control" type="number" name="name" value=""></td>
    </tr>
    <tr>
      <th><label for="">ジャンル</label></th>
    ...
    <tr>
    <th><label for="">商品名</label></th>
    <th><input class="form-control" type="text" name="name" value="" style="width:50%;"></th>
    </tr>
    <tr>
    <th><label for="example-date-input">販売開始日</label></th>
    <th><input class="form-control" id="example-date-input" type="date" name="name" value="" size="5"></th>
    </tr>
    <tr>
    <th><label for="example-date-input">販売終了日</label></th>
    <th><input class="form-control" id="example-date-input" type="date" name="name" value="" size="5"></th>
    </tr>
    <tr>
    <th><label for="">商品画像</label></th>
    <th><input class="fotm-control" type="file" name"name" value""></th>
    </tr>
    <tr>
    <th><label for="">商品説明文</label></th>
    <th><textarea class="form-control" id="exampleTextarea" rows="6" maxlength="255" ></textarea></th>
    </tr>
  </tbody>
</table>
</div>
