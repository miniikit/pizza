...
@section('main')
    <div class="container wrap">
        ...
        <div class="policy">
            ...
            <p>
                デリバリーピザショップOIC（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）におけるプライバシー情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
            </p>
            <h2 class="sub_title">第1条（プライバシー情報）</h2>
            <ul>
                <li>
            ...
            <h2 class="sub_title">第２条（プライバシー情報の収集方法）</h2>
            <ul>
                <li>
            ...
            <h2 class="sub_title">第３条（個人情報を収集・利用する目的）</h2>
            <p>
            ...
            <h2 class="sub_title">第４条（個人情報の第三者提供）</h2>
            <ul>
            ...
            <h2 class="sub_title">第５条（個人情報の開示）</h2>
            <ul>
                <li>
            ...
            <h2 class="sub_title">第６条（個人情報の訂正および削除）</h2>
            <ul>
            ...
            <h2 class="sub_title">第７条（個人情報の利用停止等）</h2>
            <p>
                当社は，本人から，個人情報が，利用目的の範囲を超えて取り扱われているという理由，または不正の手段により取得されたものであるという理由により，その利用の停止または消去（以下，「利用停止等」といいます。）を求められた場合には，遅滞なく必要な調査を行い，その結果に基づき，個人情報の利用停止等を行い，その旨本人に通知します。ただし，個人情報の利用停止等に多額の費用を有する場合その他利用停止等を行うことが困難な場合であって，本人の権利利益を保護するために必要なこれに代わるべき措置をとれる場合は，この代替策を講じます。
            </p>
            <h2 class="sub_title">第８条（プライバシーポリシーの変更）</h2>
            <ul>
                <li>本ポリシーの内容は，ユーザーに通知することなく，変更することができるものとします。</li>
                <li>当社が別途定める場合を除いて，変更後のプライバシーポリシーは，本ウェブサイトに掲載したときから効力を生じるものとします。</li>
            </ul>
            <h2 class="sub_title">第９条（お問い合わせ窓口）</h2>
            <p>
